...
class LoginRobot {
  ...
  Future<void> loginConCredencialesValidas() async {
    await ingresarEmail('test@tecnoshopper.com');
    await ingresarPassword('password123');
    await presionarBotonLogin();
    await verificarInicioDeSesionExitoso();
  }
